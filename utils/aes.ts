// AES-128-ECB 加密实现
// 参考: https://github.com/ricmoo/aes-js
...
export function aesEncryptECB(data: Uint8Array, key: Uint8Array): Uint8Array {
  ...
  const output = new Uint8Array(numBlocks * blockSize);
  ...
  for (let i = 0; i < numBlocks; i++) {
    ...
    if (end - start < blockSize) {
      const padding = blockSize - (end - start);
    ...
    output.set(encrypted, i * blockSize);
  }
